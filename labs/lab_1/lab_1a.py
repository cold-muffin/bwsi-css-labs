...
def main():
    ...
    name = "Efrat Hossain" # TODO: Insert your name between the double quotes

    print(f"{name}, Welcome to the CSS course!")
    print("My name is Efrat Hossain. I am a junior at Stuyvesant High School. I like doing calligraphy as a hobby.")
